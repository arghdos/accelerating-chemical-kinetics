...
\begin{frame}
  ...
  \begin{itemize}
   ...
   \item Method coefficients did not depend on the stepsize ratiom, (no need to solve non-linear equations at each step as in Schmitt et al.'s\footfullcite{Schmitt:2005} method), important for small problems where this cost could be prohibitive
  \end{itemize}
